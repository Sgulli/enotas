...
import type { ProductWritePayload } from "#/server/products";
    ...
    <div className="mx-auto w-full max-w-4xl p-8 md:p-12">
      ...
      <PageHeader
        ...
        actions={
          <Button
            type="button"
            className="bg-gradient-to-br from-curator-primary to-curator-primary-container font-medium text-curator-on-primary shadow-lg"
            onClick={handleEdit}
          >
